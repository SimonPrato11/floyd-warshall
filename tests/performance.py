...
if __name__ == "__main__":
    iterative_function_time = timeit.timeit(benchmark_floyd_warshall, number=RUNS)
    recursive_function_time = timeit.timeit(
        benchmark_floyd_warshall_recursive, number=RUNS
    )
...
# python -m tests.performance from root
